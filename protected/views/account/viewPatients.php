	    	 ...
	    	 <div class="table-responsive">
			    ...
			    <?php endif; ?>
	    	 	<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
	                ...
	                <tbody>
						<?php 
							foreach($activePatients as $modelValue)
							{
						?>
								<tr>
									...
									<?php 
									echo "<td>".CHtml::link('<i class="fas fa-info-circle"></i>', $this->createAbsoluteUrl('account/viewRecords', ['accountId' => $modelValue->id]), ['class' => 'btn btn-info btn-circle btn-sm'])."</td>";
