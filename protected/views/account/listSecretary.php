	                ...
	                <tbody>
						...
						?>
								<tr>
									...
									<?php 
									echo "<td>".CHtml::link('<i class="fas fa-info-circle"></i>', $this->createAbsoluteUrl('account/viewRecordsSecretary/', ['accountId' => $modelValue->id]), array('class'=>'btn btn-info btn-circle btn-sm'))."</td>";
		                            echo "<td>".CHtml::link('<i class="fas fa-edit"></i>', $this->createAbsoluteUrl('account/updateSecretary/'.$modelValue->id),array('class'=>'btn btn-success btn-circle btn-sm'))."</td>";
