            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <ul class="list-group">
                        ...
                        <?php foreach($listOfSecretary as $secretary): ?>
                            <li class="list-group">
                                <strong>Assigned to Doctor</strong>
                                <ul>
                                    <li>
                                        <!-- Display assigned doctor details -->
                                        Assigned to Doctor: <b><?php echo $secretary->doctor->user->getFullname($secretary->doctor_id); ?></b>
                                    </li>
                                </ul>
                            </li>
                        <?php endforeach; ?>
