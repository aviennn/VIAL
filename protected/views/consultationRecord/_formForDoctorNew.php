...
<div class="form-group row">
	<div class="col-sm-4 mb-4 mb-sm-0">
		...
		<?php echo $form->textArea($model,'subjective',array('rows'=>6, 'cols'=>50, 'class'=>'form-control form-control-user')); ?>
...
<div class="form-group row">
	<div class="col-sm-4 mb-4 mb-sm-0">
		...
		<?php echo $form->textArea($model,'objective',array('rows'=>6, 'cols'=>50, 'class'=>'form-control form-control-user')); ?>
...
<div class="form-group row">
	<div class="col-sm-4 mb-4 mb-sm-0">
		...
		<?php echo $form->textArea($model,'assessment',array('rows'=>6, 'cols'=>50, 'class'=>'form-control form-control-user')); ?>
...
<div class="form-group row">
	<div class="col-sm-4 mb-4 mb-sm-0">
		...
		<?php echo $form->textArea($model,'plan',array('rows'=>6, 'cols'=>50, 'class'=>'form-control form-control-user')); ?>
