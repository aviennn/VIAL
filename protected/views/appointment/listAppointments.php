...
<div class="col-xl-12 col-lg-12">
	<div class="card shadow mb-4">
	    <div class="card-header py-3">
	        <h6 class="m-0 font-weight-bold text-primary">List of Appointments</h6>
	    </div>
	    <div class="card-body">
	                ...
	                <tbody>
						...
						?>
								<tr>
									...
									<?php 
									echo "<td>".CHtml::link('<i class="fas fa-info-circle"></i>', $this->createAbsoluteUrl('appointment/view/'.$Appointment->id), array('class'=>'btn btn-info btn-circle btn-sm'))."</td>";
		                            echo "<td>".CHtml::link('<i class="fas fa-edit"></i>', $this->createAbsoluteUrl('appointment/update/'.$Appointment->id),array('class'=>'btn btn-success btn-circle btn-sm'))."</td>";
