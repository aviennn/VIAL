...
class Account extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('email_address', 'validateNewEmailAddress', 'on'=>'createNewSecretary'),
			array('username', 'validateNewUsername', 'on'=>'createNewDoctor'),
			array('username', 'validateNewUsername', 'on'=>'createNewPatient'),
			array('username', 'validateNewUsername', 'on'=>'createNewSecretary'),
			...
			array('username, password, retypepassword', 'required', 'on'=>'createNewSecretary'),
